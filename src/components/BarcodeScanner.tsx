...
import { searchProductByBarcode, ProductNutrition } from '../utils/openFoodFacts';
import { X, CheckCircle, AlertCircle, Loader, Flame, Beef, Cookie, Droplet, Wheat, Candy, Sparkles, Edit3 } from 'lucide-react';
                ...
                <div className="border-t-2 border-gray-100 pt-4 space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setEditableData(editableData ? { ...editableData, foodName: e.target.value } : null)}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setEditableData(editableData ? { ...editableData, servingSize: e.target.value } : null)}
                      className="w-full px-4 py-2 border-2 border-gray-200 rounded-xl focus:border-emerald-500 focus:outline-none"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setEditableData(editableData ? { ...editableData, calories: parseFloat(e.target.value) || 0 } : null)}
                        className="w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:border-orange-500 focus:outline-none"
                        min="0"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setEditableData(editableData ? { ...editableData, protein: parseFloat(e.target.value) || 0 } : null)}
                        className="w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:border-red-500 focus:outline-none"
                        min="0"
                        step="0.1"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setEditableData(editableData ? { ...editableData, carbs: parseFloat(e.target.value) || 0 } : null)}
                        className="w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:border-amber-500 focus:outline-none"
                        min="0"
                        step="0.1"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setEditableData(editableData ? { ...editableData, fats: parseFloat(e.target.value) || 0 } : null)}
                        className="w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:border-yellow-500 focus:outline-none"
                        min="0"
                        step="0.1"
                      />
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setEditableData(editableData ? { ...editableData, fiber: parseFloat(e.target.value) || 0 } : null)}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setEditableData(editableData ? { ...editableData, sugar: parseFloat(e.target.value) || 0 } : null)}
                        className="w-full px-2 py-1.5 border-2 border-gray-200 rounded-lg focus:border-emerald-500 focus:outline-none text-sm"
                        min="0"
                        step="0.1"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setEditableData(editableData ? { ...editableData, sodium: parseFloat(e.target.value) || 0 } : null)}
                        className="w-full px-2 py-1.5 border-2 border-gray-200 rounded-lg focus:border-emerald-500 focus:outline-none text-sm"
                        min="0"
                        step="1"
                      />
